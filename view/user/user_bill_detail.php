  ...
  <section class="page">
    <div class="container">
      <div class="page-list">
        ...
        <a href="#" class="page-name current">Đơn hàng <?= $id_bill ?></a>
      </div>
    </div>
  </section>
      ...
      <div class="user-container">
        <aside class="user-aside">
          <div class="user-column">
            <h3 class="user-title">Đơn hàng</h3>
            <div class="user-list">
              <div class="user-item">
                <a href="index.php?act=user_info" class="user-link">Tài khoản</a>
              </div>
              <div class="user-item">
                <a href="index.php?act=user_bill" class="user-link active">Đơn hàng của tôi</a>
              </div>
              <div class="user-item">

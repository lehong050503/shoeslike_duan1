  ...
  <div class="container" style="max-width: 1265px;">
    <div class=" page-title">
      <h4 class="mt-5 font-weight-bold text-center">
        Danh sách đơn hàng chưa thực hiện
      </h4>
    </div>
      ...
      <div class="box-body">
        <form action="?btn_delete_all" method="post" class="table-responsive">
          <table width="100%" class="table table-hover table-bordered text-center">
            ...
            <tbody>
              <?php
              foreach ($list_order_unfullfill as $louf) {
                extract($louf);
                $update_order = "index.php?act=update_order_unfullfill&id_order=" . $id_order;
                $delete_order = "index.php?act=delete_order_unfullfill&id_order=" . $id_order;

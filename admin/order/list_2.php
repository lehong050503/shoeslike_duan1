      ...
      <div class="box-body">
        <form action="?btn_delete_all" method="post" class="table-responsive">
          <table width="100%" class="table table-hover table-bordered text-center">
            ...
            <tbody>
              <?php
              foreach ($list_order_delivering as $lod) {
                extract($lod);
                $update_order = "index.php?act=update_order_delivering&id_order=" . $id_order;
                $delete_order = "index.php?act=delete_order_delivering&id_order=" . $id_order;
